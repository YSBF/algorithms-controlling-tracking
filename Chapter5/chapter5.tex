...
The last experiment (figure \ref{figure:hover}) consists in asking the robot to hover (stay still) on a point and perturbing it by pushing and pulling with a stick. At each spike on x, y and z an external force is applied.
